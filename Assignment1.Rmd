...
4. Is the seasonality constant or time–varying? Explain how different R functions tackle the problem; then try all possible corresponding decomposition and pick the one you reckon is the most suitable for the data.
...
df2 = DecomposedDF(year_vector = year_vector4, df=df, method = "decompose")
df3 = DecomposedDF(year_vector = year_vector0, df=df, method = "decompose")
